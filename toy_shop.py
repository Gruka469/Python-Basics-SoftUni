...
total_count = puzzel_count + talking_doll_count + teddy_bear_count + minion_count + truck_count
...
total_income = puzzel_count * PUZZLE_PRICE + talking_doll_count * TALKING_DOLL_PRICE + teddy_bear_count * TEDDY_BEAR_PRICE + minion_count * MINION_PRICE + truck_count * TRUCK_PRICE
